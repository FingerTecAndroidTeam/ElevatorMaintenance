...
public class RxApiTestActivity extends AppCompatActivity {
    ...
    public void getAllUsers(View view) {
        RxAndroidNetworking.get(Constants.BASE_URL + Constants.GET_JSON_ARRAY)
    ...
    public void getAnUser(View view) {
        RxAndroidNetworking.get(Constants.BASE_URL + Constants.GET_JSON_OBJECT)
    ...
    public void checkForHeaderGet(View view) {
        ...
        RxANRequest.GetRequestBuilder getRequestBuilder = new RxANRequest.GetRequestBuilder(Constants.BASE_URL + Constants.CHECK_FOR_HEADER);
    ...
    public void checkForHeaderPost(View view) {
        ...
        RxANRequest.PostRequestBuilder postRequestBuilder = RxAndroidNetworking.post(Constants.BASE_URL + Constants.CHECK_FOR_HEADER);
    ...
    public void createAnUser(View view) {
        RxAndroidNetworking.post(Constants.BASE_URL + Constants.POST_CREATE_AN_USER)
    ...
    public void uploadImage(final View view) {
        RxAndroidNetworking.upload(Constants.BASE_URL + Constants.UPLOAD_IMAGE)
